...
def send_mail():
    ...
    server.starttls()
    server.login('monoramasamanta82@gmail.com','zvdf tzbn bpry xlya')
    ...
    msg['From'] = 'monoramasamanta82@gmail.com'
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com',465) as smtp:
        smtp.login('monoramasamanta82@gmail.com','zvdf tzbn bpry xlya')
...
sched.add_job(send_mail,'cron',day_of_week='mon-sun', hour=00, minute=38)
sched.start()
